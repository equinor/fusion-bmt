...
public static class InitContent
{
    ...
    {
        var pathJsonRelativeToApiRoot = "Context/InitQuestions.json";
        List<QuestionTemplate> questions;

        using (var reader = new StreamReader(pathJsonRelativeToApiRoot))
        {
    ...
    private static List<Project> GetProjects()
    {
        ...
        var projects = new List<Project>(new Project[] { project1, project2 });
