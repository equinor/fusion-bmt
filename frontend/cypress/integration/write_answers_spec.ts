...
describe('Writing answers', () => {
    ...
    const evaluationFollowUp = new EvaluationSeed({
    ...
    const evaluations = [evaluationIndividual, evaluationPreparation, evaluationWorkshop, evaluationFollowUp]
