import { Organization, Progression, ProjectCategory, Question, Role } from '../../src/api/models'
...
export class EvaluationQuery {
    ...
    questionTemplates(projectCategory: string): Cypress.Chainable<Array<QuestionTemplate>> {
