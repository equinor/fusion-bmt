...
const ParticipantCardRenderer: React.FC<DataTableRowProps> = ({ item }) => <ParticipantCard participant={item.participant} />

const ProgressOrganisationRenderer: React.FC<DataTableRowProps> = ({ item }) => {
    return <>{item.progressOrg}%</>
}

const ProgressAllRenderer: React.FC<DataTableRowProps> = ({ item }) => {
    return <>{item.progressAll}%</>
}

const OrganizationRenderer: React.FC<DataTableRowProps> = ({ item }) => {
    return <>{organizationToString(item.organization)}</>
}
